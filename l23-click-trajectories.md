...
Administrivia:
   ...
   -Final project presentations: we will post a
    schedule.
        *3 minutes per group.
        *We tentatively plan to do a 2-hour session
         until 1pm.
        *Let us know if your group has a hard
         conflict with 12:30pm--1pm.
       ...
       *Some types of attacks are done for ideological
        ...
        motivator.
             ...
             -Economic penalties would likely
              ...
              have poor accountability. Ex: Where
   ...
   -Ex: In China, spammers often hire "text-message
    ...
    car can send 200,000 messages a day!
        ...
        cars are a lucrative business.
         ...
         [Ref: The Economist, "Spam messaging:
          106 ways to annoy." November 29, 2014]

   -There are many companies which trade
    in "cyber arms." Ex: Endgame.
...
for evil purposes.
   -Compromised systems
       ...
       *Running a service on an existing botnet
        (spam, DoS).
   -Tools
       *Malware kits
       *Bugs, exploits
   -Stolen information
       *SSNs, credit cards numbers, email addresses,
        etc.
...
Advertising: How do you get a user to click on
a link?
   ...
   -How can we make sending spam more expensive?
        ...
        *Charging for sending email?
            -Old idea, in various forms: money,
             computation, CAPTCHAs.
            -Can this work? How could we get everyone
             to adopt this at once?
...
to CAPTCHAs?
   ...
   -Providers can implement more frequent checks
    ...
    get annoyed if the checks are too frequent.
        *Ex: Gmail lets you enable two-factor
...
Click support: The user contacts DNS to translate
a hostname into an IP address; then, the user
contacts the associated web server. So, the
spammer needs to:
...
or to stop botnets involving their machines.
   -Ex: In 2013, Microsoft, American Express, PayPal,
